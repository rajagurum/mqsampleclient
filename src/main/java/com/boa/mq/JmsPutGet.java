...
public class JmsPutGet {
	 ...
	 * @param args
	 */
	public void putMessage(User user ) {
		...
		try {
			...
			TextMessage message = context.createTextMessage("Name " + user.getName() +"  Age "+user.getAge()+"  Inserted at Millisecond "+uniqueNumber);
	...
	public String readMessage() {
		...
		String receivedMessage = "Nothing read from Queue";
